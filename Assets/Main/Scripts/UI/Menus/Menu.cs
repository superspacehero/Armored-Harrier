...
public class Menu : MonoBehaviour
{
    ...
    [SerializeField, Foldout("Variables")]
    protected GameObject _objectToSelect;

    [Foldout("Variables"), Min(0)]
...
#if UNITY_EDITOR
    [Button("Other Menus/Set Connected Menu Objects"), ContextMenu("Set Connected Objects")]
    ...
    [Button("Other Menus/Previous Menu"), ContextMenu("Previous Menu")]
    ...
    [Button("Other Menus/Next Menu"), ContextMenu("Next Menu")]
    ...
    [Button("Selectables/Keep Selectables"), ContextMenu("Find Selectables (Keep Existing Ones)")]
    private void KeepSelectables()
    {
        FindSelectables(clearList: false);
    }

    [Button("Selectables/Clear Selectables"), ContextMenu("Find Selectables (Clear Existing Ones)")]
    ...
    [SerializeField, ShowIf("hasEventTrigger"), Foldout("Event Trigger")]
    protected bool previousMenuOnCancel = true;

#if UNITY_EDITOR
    [Button("Event Trigger/Add Event Trigger"), ContextMenu("Add Event Trigger"), HideIf("hasEventTrigger")]
