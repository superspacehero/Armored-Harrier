...
public class MovementController : Controller
{
    ...
    void Start()
    {
        ...
        GameplayCamera gameplayCamera = GetComponentInChildren<GameplayCamera>();
    ...
    [SerializeField, InfoBox("If left empty, the base object will be used."), Foldout("Rotation")]
    ...
    public void Rotate(Vector3 direction)
    {
        switch (rotationBehavior)
        {
            ...
            case MovementRotationBehavior.LeftRightRotation:
                ...
                direction.z *= 0.5f;
                break;
            case MovementRotationBehavior.TowardsCamera:
    ...
    [Button("Rotation/Random Rotation")]
